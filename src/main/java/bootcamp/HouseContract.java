...
public class HouseContract implements Contract {
    ...
    public void verify(LedgerTransaction tx) throws IllegalArgumentException {
        ...
        List<PublicKey> requireSigners = command.getSigners();
        ...
        if (commandType instanceof Register) {
            ...
            if (!(requireSigners.contains(ownersKey))) {
            ...
            if (!(requireSigners.contains(inputOwner.getOwningKey()))) {
                throw new IllegalArgumentException("Current owner should sign the transfer");
            }

            if (!(requireSigners.contains(outputOwner.getOwningKey()))) {
